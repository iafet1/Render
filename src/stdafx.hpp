...
union Variant
{
    ...
    int32_t iData32[2]; // массив (2) 32 бит
    int16_t iData16[4]; // массив (4) 16 бит
    int8_t iData8[8];   // массив (8) 16 бит

    uint32_t uData32[2]; // массив (2) 32 бит
    uint16_t uData16[4]; // массив (4) 16 бит
    uint8_t uData8[8];   // массив (8) 16 бит

    float fData[2]; // массив 2-х чисел одинарной точности
};
